// /components/patrocinadores/patrocinadores_comp.js

import PATROCINADORES from "/api/sponsors.mjs";
  ...
  connectedCallback() {
    ...
    PATROCINADORES.forEach((patrocinador) => {
      ...
      gridContainer.innerHTML += `
        ...
        patrocinador.nombre
      }" class="patrocinador__logo" loading="lazy">
          ...
          ${
            patrocinador.redes.web
              ? `
            <a href="${patrocinador.redes.web}" target="_blank" rel="noopener noreferrer" class="patrocinador__web">
  ...
  generateSocialLinks(redes) {
    ...
    if (redes.instagram) {
      linksHTML += `
        <a href="${
          redes.instagram
        }" target="_blank" rel="noopener noreferrer" class="redes__link" aria-label="Instagram de ${redes.instagram
        .split("/")
        .pop()}">
    ...
    if (redes.twitter) {
      linksHTML += `
        <a href="${
          redes.twitter
        }" target="_blank" rel="noopener noreferrer" class="redes__link" aria-label="Twitter de ${redes.twitter
        .split("/")
        .pop()}">
          <svg class="redes__icon" viewBox="0 0 24 24" fill="currentColor">
    ...
    if (redes.facebook) {
      linksHTML += `
        <a href="${
          redes.facebook
        }" target="_blank" rel="noopener noreferrer" class="redes__link" aria-label="Facebook de ${redes.facebook
        .split("/")
        .pop()}">
          <svg class="redes__icon" viewBox="0 0 24 24" fill="currentColor">
