let SHOP_PRODUCTS = [
...

  {
    ...
    pageName: "pack_equipacion_portera",
    pageURL: "/pages/producto_tienda.html?producto=pack_equipacion_portera",
    selections: [
      {
        name: "Talla Camiseta",
        isRequired: true,
...

  {
    ...
    pageName: "pack_segunda_equipacón",
    pageURL: "/pages/producto_tienda.html?producto=pack_segunda_equipacón",
    selections: [
      {
        name: "Talla Camiseta",
        isRequired: true,
